      ...
      >
        ...
        <div className="relative z-20 flex flex-col items-center justify-between h-full px-5 py-6 sm:px-7 sm:py-8">
          ...
          <div className="text-center">
            ...
            >
              I can answer questions, guide visitors, and help them navigate
          ...
          <div className='relative mb-1'>
            ...
            <button
                className={`relative w-12 h-12 sm:w-16 sm:h-16 md:w-18 md:h-18 rounded-full bg-gradient-to-br ${current.button} ${current.micGlow} flex items-center justify-center`}
            >
